...
//====================================================================================================================
		...
		//O que é o casting: Casting é uma conversão explícita de tipos de dados.
		
		//Ex:. No exemplo abaixo a resposta normal serie 2.5. Por aA e bB serem int(inteiros) o compilador vai entender que a 
		// divisão será entre os números inteiros. Porém, como a resposta seria 2.5, seria necessário usar o casting, para que
		// o compilador entendesse que a divisão seria com o double, para manter as casas decimais.
		...
		// Para resolver, é necessário usar o casting, que é utilizar o double entre parenteses, após a atribuição e 
		//antes das variáveis.
		//Serve também pro int. Que ocorre quando as casas decimais não fazem falta no resultado
